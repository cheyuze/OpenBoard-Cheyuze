...
win32 {
   UB_FFMPEG_RUNTIME.files = \
      thirdparty/ffmpeg/ffmpeg-9.0.1-full_build-shared/bin/avcodec-63.dll \
      thirdparty/ffmpeg/ffmpeg-9.0.1-full_build-shared/bin/avformat-63.dll \
      thirdparty/ffmpeg/ffmpeg-9.0.1-full_build-shared/bin/avutil-61.dll \
      thirdparty/ffmpeg/ffmpeg-9.0.1-full_build-shared/bin/swresample-7.dll \
      thirdparty/ffmpeg/ffmpeg-9.0.1-full_build-shared/bin/swscale-10.dll
   UB_FFMPEG_RUNTIME.path = $$DESTDIR
   INSTALLS += UB_FFMPEG_RUNTIME
}
